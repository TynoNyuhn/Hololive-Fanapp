...
struct UsadaPekora: View {
    ...
    @State var videoName = "PV1"
    @State var videoPlayer = AVPlayer(url: Bundle.main.url(forResource: "PV1", withExtension: "mp4")!)
    @State var videos = ["PC1", "PC2"]
    @State var videoPosition = 0
    @State var mediaTypes  = ["BGM", "Music Videos", "Random Videos"]
    @State var mediaChoice = 0
    @State var images = ["PV1", "PV2", "PV3", "PV4","PV5"]
    @State var audioPlayer: AVAudioPlayer!
    @State var soundFile = "PekoraBGM"
    @State var BGMs = ["PekoraBGM", "PekoraBGM2", "PekoraBGM3"]
    ...
    @State private var pageName: String = "UsadaPekora"
            ...
            VStack {
                ...
                if (mediaChoice != 0) {
                    VideoPlayer(player: videoPlayer)
                        ...
                        .overlay(Rectangle()
                                    .strokeBorder(
                                        LinearGradient(gradient: Gradient(colors: [.blue, .orange]), startPoint: .leading, endPoint: .trailing),
                                        lineWidth: 5
                                    )
                        ).onAppear {
                ...
                VStack {
                    ...
                    Text("A lonely rabbit-eared girl who loves carrots. She loves them so much that she always brings a few anywhere she goes.")
                        .font(.pixelate(size:18))
                        .padding()
                    Text("Pekora has a very playful personality. Often playing pranks on her members\nSince she's the princess of Pekoland, she has a very unique accent - often including the word \"Peko\" in her speech.")
                        .font(.pixelate(size:18))
                        .padding()
                    Text("Birthday: January 12th\nDebut Date: July 17, 2019\nFanbase: Nousagi")
                        .font(.pixelate(size:18))
                        .padding()
                    HStack {
                        VStack {
                        Link(destination: URL(string: "https://www.youtube.com/channel/UC1DCedRgGHBdm81E1llLhOQ")!) {
                            Image("YouTube")
                                .resizable()
                        ...
                        VStack {
                        Link(destination: URL(string: "https://twitter.com/usadapekora")!) {
                            Image("Twitter")
                                .resizable()
...
struct UsadaPekora_Previews: PreviewProvider {
